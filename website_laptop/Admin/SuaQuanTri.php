    ...
    <div class="main-content">
        ...
        <h1>Sửa thông tin quản trị</h1>
            ...
            if(isset($_REQUEST['btndongy'])){
                ...
                $quanTri->hoTen = $hoTen;
                $quanTri->anh =$anh;
                $result = $bus->sua($quanTri);
                if($result){
                    $thongBao ="Cập nhật thành công!!!";
                }
                else $thongBao ="Cập nhật không thành công!!! Mời kiểm tra lại!";
            }
            ?>
            <form method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                <a href="QuanLyQuanTri.php">Quay về trang quản lý quản trị</a>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tên đăng nhập </label>

                    <div class="col-sm-9">
                        <input type="text" value="<?php echo $tenDangNhap?>" readonly id="form-field-1" placeholder="Tên đăng nhập" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
