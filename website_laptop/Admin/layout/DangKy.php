...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            $ngaySinh="";$ngay="";$thang="";$nam="";$gioiTinh="";$email="";$anh="";$maKH="";
                ...
                if(isset($_POST['gioitinh'])) {
                    ...
                    if ($quanTri == null) {
                        if ($khachHang == null) {
                            ...
                            $khachHang->anh = $anh;
                            $khachHang->maKH = $maKH;
                            $result = $busKH->themMoi($khachHang);
                            if ($result) {
                                $thongBao = "Đăng ký thành công!!!";
                            } else $thongBao = "Đăng ký thất bại!!!Mời xem lại!";
                        } else $thongBao = "Tài khoản đã tồn tại!!!Mời nhập tài khoản khác!";
                    } else $thongBao = "Tài khoản đã tồn tại!!!Mời nhập tài khoản khác!";
                }else $thongBao ="Mời chọn giới tính!!!";
            }
            ?>
            ...
            <form method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txttendangnhap" value="<?php echo $tenDangNhap;  ?>" id="form-field-1" placeholder="Tên đăng nhập" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txtngaysinh" style="width: 100px" value="<?php echo $ngay ?>" id="form-field-1" placeholder="Ngày" class="col-xs-10 col-sm-5" />
                        <input type="text" name="txtthangsinh" style="width: 100px" value="<?php echo $thang ?>" id="form-field-1" placeholder="Tháng" class="col-xs-10 col-sm-5" />
                        <input type="text" name="txtnamsinh" style="width: 190px" value="<?php echo $nam ?>" id="form-field-1" placeholder="Năm" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="clearfix form-actions">
                    <div style="margin-left: 350px" class="col-md-offset-3 col-md-9">
                        <input name="btndongy" class="btn btn-info" type="submit" value="Đăng ký"/>
